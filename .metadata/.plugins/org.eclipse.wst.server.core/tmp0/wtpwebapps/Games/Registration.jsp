...
<body>
	...
	<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<img src="images/login.png" height = "200" width = "220">
						  ...
						  <p>-- Fill out this form to Become a Member --</p>
						  <pre>
        <form  action="RegServlet" method="post">
        
        <table> 
         <tr>
        	<th><label class="main">Name : </label></th> 
        	<th>
        ...
        <tr>
        	<th><label class="main">Mobile : </label></th> 
        	<th>
         ...
         <tr>
        	<th><label class="main">Email: </label></th> 
        	<th>
        ...
        <tr>
        	<th><label class="main">Country: </label></th> 
        	<th>
        ...
        <tr>
        	<th><label class="main">Password: </label></th> 
        	<th>
        ...
        <tr>
        	<th><label class="main">Re-Type Password: </label></th> 
        	<th>
        	<input type="password" placeholder="Re-Type password" name="cpassword">
                 ...
                 <input type = "submit" value = "Register" style = "background:#38A9E3;
